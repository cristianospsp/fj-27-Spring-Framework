		...
		<div class="mdl-cell mdl-cell--4-col">
			...
			<div class="mdl-cell mdl-cell--12-col">
				<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
					...
					<label class="mdl-textfield__label" for="title">T�tulo</label>
				</div>
			</div>
			...
			<div class="mdl-cell mdl-cell--12-col">
				<div
					...
					<label class="mdl-textfield__label" for="description">Descri��o</label>
				</div>
			</div>
			...
			<div class="mdl-cell mdl-cell--12-col">
				<div
					...
					<form:input path="numberOfPages" class="mdl-textfield__input" type="text"
								...
								class="mdl-textfield__label" for="numberOfPages"> N�mero de P�ginas </label> <span
